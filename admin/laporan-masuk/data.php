...
$group_anggota = mysqli_query($conn, "SELECT id_anggota FROM tb_aspirasi WHERE (status_aspirasi='Kirim' OR status_aspirasi='Approve') AND id_jadwal='$dta_jadwal[id_jadwal]' GROUP BY id_anggota");
