          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="nama_komisi" placeholder="Komisi I" name="nama_komisi"class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Bidang</label>
                <input type="text" id="bidang_komisi" placeholder="Bidang Pemerintahan" name="bidang_komisi"class="form-control">
              </div>

              <div class="col-12">
              <button type="submit" name="submit_komisi" class="btn btn-success float-right" style="margin-top: 3% ; margin-left: 2%;">Simpan</button>
