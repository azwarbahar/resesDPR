          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="nama_jadwal" name="nama_jadwal"class="form-control">
              </div>
              ...
              <div class="col-12">
              <button type="submit" name="submit_jadwal" class="btn btn-success float-right" style="margin-top: 3% ; margin-left: 2%;">Simpan</button>
