        ...
        <div class="col-md-10">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Tambah Fraksi</h3>
            ...
            <div class="card-body">
              ...
              <div class="col-12">
              <button type="submit" name="submit_fraksi" class="btn btn-success float-right" style="margin-top: 3% ; margin-left: 2%;">Simpan</button>
