        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/reses-dprd/anggota-dpr/profile-dpr/data.php">Profil</a></li>
    ...
    <form method="POST" action="controller.php" enctype="multipart/form-data">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="id" id="id" value="<?= $get_id_session ?>">
                <input id="username" name="username" value="<?= $get_data_akun['username'] ?>" class="form-control" required>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <div class="form-group" style="text-align: center;">
                <img src="/reses-dprd/admin/profile-dpr/foto/<?php echo $dta['foto_anggota'] ?>" id="blah" alt="" class="img img-fluid" style="max-height: 300px; max-width: 300px;">
              </div>
              <!-- Button Unggah -->
              <div class="form-group" style="text-align: center;">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <button type="submit" name="update_anggota" class="btn btn-success float-right"  style=" margin-left: 2%">Simpan</button>
